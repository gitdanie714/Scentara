...
function Header() {
  return (
    <div className='flex justify-between items-center min-h-96 max-w-full object-cover bg-pink p-4'>
      <div className='flex-col justify-center items-start text-left '>
        <h1 className='text-darkred text-7xl text-left font-semibold m-2 '>Choose your Signature Scent </h1>
